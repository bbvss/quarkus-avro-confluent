...
public class Movie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6903328263865496685L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Movie\",\"namespace\":\"org.acme.movie\",\"fields\":[{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"year\",\"type\":\"int\"}]}");
   ...
   */
  public static org.acme.movie.Movie.Builder newBuilder() {
    return new org.acme.movie.Movie.Builder();
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static org.acme.movie.Movie.Builder newBuilder(org.acme.movie.Movie.Builder other) {
    if (other == null) {
      return new org.acme.movie.Movie.Builder();
    } else {
      return new org.acme.movie.Movie.Builder(other);
    }
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static org.acme.movie.Movie.Builder newBuilder(org.acme.movie.Movie other) {
    if (other == null) {
      return new org.acme.movie.Movie.Builder();
    } else {
      return new org.acme.movie.Movie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Movie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.acme.movie.Movie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.acme.movie.Movie other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.title)) {
        this.title = data().deepCopy(fields()[0].schema(), other.title);
     ...
     * @return This builder.
     */
    public org.acme.movie.Movie.Builder setTitle(java.lang.String value) {
     ...
     * @return This builder.
     */
    public org.acme.movie.Movie.Builder clearTitle() {
      title = null;
     ...
     * @return This builder.
     */
    public org.acme.movie.Movie.Builder setYear(int value) {
     ...
     * @return This builder.
     */
    public org.acme.movie.Movie.Builder clearYear() {
